...
<div id="man_zone">
    ...
    <?php echo form_open(site_url('admin/article/saveEdit/'.$id), array('class'=>"jnice","onsubmit"=>"return check_form()"));?>
  	<table width="96%" border="0" align="center"  cellpadding="3" cellspacing="1" class="table_style">
    	...
    	<tr>
    		<td class="left_title_1">深度原创来源</td>
    	...
    	<tr>
      		<td class="left_title_2">深度原创内容</td>
      		<td> <?php echo $kindeditor;?></td>

    	</tr>
        <!--
    	<tr>
      		<td class="left_title_1">深度原创状态</td>
      		<td>
    	...
    	<tr>
      		<td class="left_title_2">深度原创优先</td>
      		<td>
      			<input type="checkbox" name="top" value="1" />置顶深度原创  &nbsp;&nbsp;
      			<input type="checkbox" name="recommend" value="1" />推荐深度原创  &nbsp;&nbsp;
      		</td>
    	</tr>
        <tr>
