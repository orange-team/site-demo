...
<div id="wraper">
    <div class="content clearfloat">
        ...
        <?php echo form_open(site_url('user_act/reg/'.urlencode($this->_ref)), array('name'=>'reg_form','id'=>'reg_form',"onsubmit"=>"return chk_reg()"));?>
            <h1>注册蜡笔画</h1>
            <div class="field-input clearfloat">
                ...
                <label for="nickname" class="err_txt clearfloat"></label>
                <div id="customer_email_wrap" class="field err">
                    <input type="email" value="" placeholder="邮箱" tabindex="2" class="input" name="email" maxlength="255" id="email">
                </div>
                <label for="email" class="err_txt clearfloat"></label>
                ...
                <label for="password" class="err_txt clearfloat"></label>
                <div class="authcode">
